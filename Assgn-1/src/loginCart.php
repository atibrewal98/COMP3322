<?php include('verifyCartLogin.php') ?>
<html>
    <head>
        <meta charset="utf-8"/>
    ...
    <?php include('bodyHandler.php') ?>
        ...
        <div class = "btns">
            <span class = "txt" id = "sgn_in" onclick= "window.location.href = 'loginCart.php'">Sign In</span>
        ...
        <div class = "whitebox">
            ...
            <form action = "loginCart.php" method = "POST">
        ...
        <script type = "text/javascript">
            ...
            function callLogin(){
                setTimeout(() => {
                    window.location.href = "loginCart.php";
                }, 3000);
            }
        </script>
    </body>
